...
{
      10,    11,    14,    15,     1,    17,    18,    19,    20,    21,
       5,     6,     7,    12,    13,    14,    15,     8,     3,    16,
      12,    13,    14,    15,     4
};

static const yytype_int8 yycheck[] =
{
       7,     8,     7,     8,     4,    12,    13,    14,    15,    16,
       3,     4,     5,     5,     6,     7,     8,    10,    12,    11,
       5,     6,     7,     8,     0
};
...
{
       0,     4,    14,    12,     0,     3,     4,     5,    10,    15,
      15,    15,     5,     6,     7,     8,    11,    15,    15,    15,
      15,    15
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* ASSIGNMENT: VAR '=' EXPR  */
#line 33 "pmcd45.y"
                      {
           	strcpy(q[index1].op,"=");
           	strcpy(q[index1].arg1,(yyvsp[0].var));
           	strcpy(q[index1].arg2,"");
           	strcpy(q[index1].result,(yyvsp[-2].var));
           	strcpy((yyval.var),q[index1++].result);
            	}
#line 1157 "y.tab.c"
    break;
...
#line 41 "pmcd45.y"
                 {addqruple("+",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1163 "y.tab.c"
    break;
...
#line 45 "pmcd45.y"
                    {strcpy((yyval.var),(yyvsp[-2].var));}
#line 1187 "y.tab.c"
    break;

  case 8: /* EXPR: '-' EXPR  */
#line 46 "pmcd45.y"
             {addqruple("uminus",(yyvsp[0].var),"",(yyval.var));}
#line 1193 "y.tab.c"
    break;
